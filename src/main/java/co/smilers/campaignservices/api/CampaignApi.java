...
public interface CampaignApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "successful operation", response = ModelApiResponse.class),
        @ApiResponse(code = 405, message = "Invalid input") })
    @RequestMapping(value = "/campaign/answerGeneralScore/{account}",
        produces = { "application/xml; charset=utf-8", "application/json; charset=utf-8" }, 
        consumes = { "application/json; charset=utf-8", "application/xml; charset=utf-8" },
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> addAnswerGeneralScore(@ApiParam(value = "Cuenta activa y asociada a la sede", required = true) @PathVariable("account") String account, @ApiParam(value = "Objecto de resultado que será agregado", required = true) @Valid @RequestBody List<AnswerGeneralScore> answerGeneralScore);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "successful operation", response = ModelApiResponse.class),
        @ApiResponse(code = 405, message = "Invalid input") })
    @RequestMapping(value = "/campaign/answerScore/{account}",
        produces = { "application/xml; charset=utf-8", "application/json; charset=utf-8" }, 
        consumes = { "application/json; charset=utf-8", "application/xml; charset=utf-8" },
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> addAnswerScore(@ApiParam(value = "Cuenta activa y asociada a la sede", required = true) @PathVariable("account") String account, @ApiParam(value = "Objecto de resultado que será agregado", required = true) @Valid @RequestBody List<AnswerScore> answerScore);
    ...
    @ApiOperation(value = "Agregar solicitud de asistencia", nickname = "addRequestAssistance", notes = "Agregar nueva solicitud de asistencia", response = ModelApiResponse.class, authorizations = {
        @Authorization(value = "petstore_auth", scopes = {
            @AuthorizationScope(scope = "read:buttons", description = "read your experience"),
            @AuthorizationScope(scope = "write:buttons", description = "modify experience in your account")
            })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "successful operation", response = ModelApiResponse.class),
        @ApiResponse(code = 405, message = "Invalid input") })
    @RequestMapping(value = "/campaign/requestAssistance/{account}",
        produces = { "application/xml; charset=utf-8", "application/json; charset=utf-8" }, 
        consumes = { "application/json; charset=utf-8", "application/xml; charset=utf-8" },
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> addRequestAssistance(@ApiParam(value = "Cuenta activa y asociada a la sede", required = true) @PathVariable("account") String account, @ApiParam(value = "Objecto de solicitud", required = true) @Valid @RequestBody List<RequestAssistance> requestAssistance);
    ...
    @ApiOperation(value = "Lista campañas de un dispositivo", nickname = "listCampaignDevice", notes = "Lista campañas de un dispositivo", response = CampaignDevice.class, responseContainer = "List", authorizations = {
        @Authorization(value = "petstore_auth", scopes = {
            @AuthorizationScope(scope = "read:buttons", description = "read your experience"),
            @AuthorizationScope(scope = "write:buttons", description = "modify experience in your account")
            })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = CampaignDevice.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "Invalid status value"),
        @ApiResponse(code = 401, message = "Unauthorized user") })
    @RequestMapping(value = "/campaign/campaignDevice/{account}",
        produces = { "application/json; charset=utf-8", "application/xml; charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<CampaignDevice>> listCampaignDevice(@ApiParam(value = "Cuenta activa y asociada a la sede", required = true) @PathVariable("account") String account, @ApiParam(value = "Zona") @Valid @RequestParam(value = "zone", required = false) Integer zone, @ApiParam(value = "Campaña") @Valid @RequestParam(value = "campaign", required = false) Integer campaign, @ApiParam(value = "IdPush") @Valid @RequestParam(value = "idPush", required = false) String idPush);


    @ApiOperation(value = "Lista píe de página", nickname = "listCampaignFooter", notes = "Lista los píe de página de una campaña", response = CampaignFooter.class, responseContainer = "List", authorizations = {
        @Authorization(value = "petstore_auth", scopes = {
            @AuthorizationScope(scope = "read:buttons", description = "read your experience"),
            @AuthorizationScope(scope = "write:buttons", description = "modify experience in your account")
            })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = CampaignFooter.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "Invalid status value"),
        @ApiResponse(code = 401, message = "Unauthorized user") })
    @RequestMapping(value = "/campaign/campaignFooter",
        produces = { "application/json; charset=utf-8", "application/xml; charset=utf-8" }, 
        method = RequestMethod.GET)
    ...
    @ApiOperation(value = "Lista preguntas", nickname = "listQuestion", notes = "Lista las preguntas", response = QuestionItem.class, responseContainer = "List", authorizations = {
        @Authorization(value = "petstore_auth", scopes = {
            @AuthorizationScope(scope = "read:buttons", description = "read your experience"),
            @AuthorizationScope(scope = "write:buttons", description = "modify experience in your account")
            })
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid status value"),
        @ApiResponse(code = 401, message = "Unauthorized user") })
    @RequestMapping(value = "/campaign/question",
        produces = { "application/json; charset=utf-8", "application/xml; charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<QuestionItem>> listQuestion(@NotNull @ApiParam(value = "Usuario asociado a la cuenta", required = true) @Valid @RequestParam(value = "user", required = true) String user, @ApiParam(value = "Título") @Valid @RequestParam(value = "title", required = false) String title, @ApiParam(value = "Descripción") @Valid @RequestParam(value = "description", required = false) String description, @ApiParam(value = "Pregunta publicada") @Valid @RequestParam(value = "isPublished", required = false) Boolean isPublished);


    @ApiOperation(value = "Lista celulares", nickname = "listSmsCellPhone", notes = "Lista celulares", response = SmsCellPhone.class, responseContainer = "List", authorizations = {
        @Authorization(value = "petstore_auth", scopes = {
            @AuthorizationScope(scope = "read:buttons", description = "read your experience"),
            @AuthorizationScope(scope = "write:buttons", description = "modify experience in your account")
            })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SmsCellPhone.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "Invalid status value"),
        @ApiResponse(code = 401, message = "Unauthorized user") })
    @RequestMapping(value = "/campaign/smsCellPhone/{account}",
        produces = { "application/json; charset=utf-8", "application/xml; charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<SmsCellPhone>> listSmsCellPhone(@ApiParam(value = "Cuenta activa y asociada a la sede", required = true) @PathVariable("account") String account, @ApiParam(value = "Zona") @Valid @RequestParam(value = "zone", required = false) Integer zone, @ApiParam(value = "Campaña") @Valid @RequestParam(value = "campaign", required = false) Integer campaign, @ApiParam(value = "Sede") @Valid @RequestParam(value = "headquaeter", required = false) Integer headquaeter);


    @ApiOperation(value = "Lista campañas en zonas", nickname = "listTargetZone", notes = "Lista campañas en zonas", response = TargetZone.class, responseContainer = "List", authorizations = {
        @Authorization(value = "petstore_auth", scopes = {
            @AuthorizationScope(scope = "read:buttons", description = "read your experience"),
            @AuthorizationScope(scope = "write:buttons", description = "modify experience in your account")
            })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = TargetZone.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "Invalid status value"),
        @ApiResponse(code = 401, message = "Unauthorized user") })
    @RequestMapping(value = "/campaign/targetZone/{account}",
        produces = { "application/json; charset=utf-8", "application/xml; charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<TargetZone>> listTargetZone(@ApiParam(value = "Cuenta activa y asociada a la sede", required = true) @PathVariable("account") String account, @ApiParam(value = "Zona") @Valid @RequestParam(value = "zone", required = false) Integer zone, @ApiParam(value = "Campaña") @Valid @RequestParam(value = "campaign", required = false) Integer campaign);
